...
public class StructuredOutputController
{
    ...
    /**
     * http://localhost:8007/structuredoutput/chat3?sname=Action&email=zzyybs@126.com
     * @param sname
     * @return
     */
    @GetMapping("/structuredoutput/chat3")
    public StudentRecord chat3(@RequestParam(name = "sname") String sname,
                               @RequestParam(name = "email") String email) {

        String stringTemplate = "学号1003，我叫{sname},大学专业动漫设计,邮箱{email}";
